...
def compare(i, factor, shift, results_folder, genDir, vaeDir, spectra_path):
    ...
    plt.imshow(img)
    plt.imsave(results_folder+ '/Results_qgan_betavae_abs/' + str(i) + '-test.png',img)
...
indices = [0, 1280, 1290, 2016, 2159, 5308, 8936, 10680, 17000]
# indices = []
...
im_size = 64
im_path = results_folder+ '/Results_qgan_betavae_abs/*-test.png'
